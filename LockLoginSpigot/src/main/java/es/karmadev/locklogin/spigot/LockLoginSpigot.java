...
import es.karmadev.locklogin.spigot.protocol.SpigotProtocol;
...
public class LockLoginSpigot implements LockLogin, NetworkServer {
    ...
    public LockLoginSpigot(final SpigotPlugin plugin, final CommandMap map) throws RuntimeException, NoSuchAlgorithmException {
        this.plugin = plugin;
