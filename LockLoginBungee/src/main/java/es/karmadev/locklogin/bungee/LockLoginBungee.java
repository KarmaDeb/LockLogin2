...
import es.karmadev.locklogin.bungee.network.BungeeProtocol;
...
public class LockLoginBungee implements LockLogin, NetworkServer {
    ...
    void installDriver() {
        ...
        for (ServerInfo info : ProxyServer.getInstance().getServers().values()) {
            CServerFactory factory = default_server_factory;
            NetworkServer created = factory.create(info.getName(), (InetSocketAddress) info.getSocketAddress());

            network.appendServer(created);
        }
    }
