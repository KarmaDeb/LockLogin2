...
public class AbstractCommand extends ModuleCommand {
     ...
     */
    public AbstractCommand(final Module module, final String cmd, final String description, final String... aliases) {
